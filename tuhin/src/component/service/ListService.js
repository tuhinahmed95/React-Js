...
export default function ListService() {
    ...
    const deletNews = (id) => {
        axios.get(`http://localhost/tuhin/backend/service/deleteService.php?id=${id}`)
            .then((res) => {
    ...
    return (
        <div className='container card card-body'>
            <div>
                ...
                <NavLink to={'/service/addservice'} className="btn btn bg-primary">Add New</NavLink><br />
            </div>
                    ...
                    {data.map((d, i) => {
                        return (
                            <tr key={i}>
                                ...
                                <td>
                                    <NavLink to={`/service/updateservice/${d.id}`}>
