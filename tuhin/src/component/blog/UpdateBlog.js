...
export default function UpdateBlog() {
    ...
    useEffect(()=>{
        axios.get(`http://localhost/tuhin/backend/blog/getBlog.php?id=${id}`)
        .then((res)=>{
    ...
    const save=()=>{
        ...
        axios.post("http://localhost/tuhin/backend/blog/updateBlog.php",formdata,{
            headers:{
    ...
    return (
        <div className='container card card-body'>
            <div>
            <h1 className="bg-secondary text-center text-bold">Update blogs</h1>

<NavLink to={'/blog/listblog'} className="btn btn bg-primary">blogs List</NavLink><br />
